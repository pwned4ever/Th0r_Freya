...
#define IO_OBJECT_NULLK  (0)
#define kIONVRAMForceSyncNowPropertyKey        "IONVRAM-FORCESYNCNOW-PROPERTY"

enum
{
    kIOCFSerializeToBinaryMS1          = 0x00000001U,
};


enum
{
    kIORegistryIterateRecursivelyMS1   = 0x00000001U,
    kIORegistryIterateParentsMS1       = 0x00000002U,
};

enum
{
    kOSSerializeDictionaryMS1          = 0x01000000U,
    kOSSerializeArrayMS1               = 0x02000000U,
    kOSSerializeSetMS1                 = 0x03000000U,
    kOSSerializeNumberMS1              = 0x04000000U,
    kOSSerializeSymbolMS1              = 0x08000000U,
    kOSSerializeStringMS1              = 0x09000000U,
    kOSSerializeDataMS1                = 0x0a000000U,
    kOSSerializeBooleanMS1             = 0x0b000000U,
    kOSSerializeObjectMS1              = 0x0c000000U,
    
    kOSSerializeTypeMaskMS1            = 0x7F000000U,
    kOSSerializeDataMaskMS1            = 0x00FFFFFFU,
    
    kOSSerializeEndCollectionMS1       = 0x80000000U,
    
    kOSSerializeMagicMS1               = 0x000000d3U,
};
...
kern_return_t IOObjectRelease_OG(io_object_t object);
...
io_object_t IOIteratorNext_OG(io_iterator_t it);
boolean_t IOIteratorIsValid(io_iterator_t it);
void IOIteratorReset(io_iterator_t it);

CFMutableDictionaryRef IOServiceMatching_OG(const char *name) CF_RETURNS_RETAINED;
CFMutableDictionaryRef IOServiceNameMatching(const char *name) CF_RETURNS_RETAINED;
io_service_t IOServiceGetMatchingService_OG(mach_port_t master, CFDictionaryRef matching CF_RELEASES_ARGUMENT);
kern_return_t IOServiceGetMatchingServices_OG(mach_port_t master, CFDictionaryRef matching CF_RELEASES_ARGUMENT, io_iterator_t *it);
...
kern_return_t IOServiceOpen_OG(io_service_t service, task_t task, uint32_t type, io_connect_t *client);
kern_return_t IOServiceClose_OG(io_connect_t client);
...
kern_return_t IOConnectTrap6_OG(io_connect_t client, uint32_t index, uintptr_t a, uintptr_t b, uintptr_t c, uintptr_t d, uintptr_t e, uintptr_t f);
