...
int *
create_pipesPF(size_t *pipe_count) {
...
void
close_pipesPF(int *pipefds, size_t pipe_count) {
    for (size_t i = 0; i < pipe_count; i++) {
        pipe_closePF(pipefds + 2 * i);
    }
}

size_t
pipe_sprayPF(const int *pipefds, size_t pipe_count,
