...
uint32_t kernel_offsets_11_0[] = {
    ...
    0x240, // KSTRUCT_OFFSET_PPOC_NAME
    0x248, // KSTRUCT_OFFSET_P_TEXTVP
    0xA8, // KSTRUCT_OFFSET_CSB_BLOB_PLATFORM_BINARY
    ...
    0x980, //KSTRUCT_OFFSET_MOUNT_MNT_DEVVP;
    0x0, // KSTRUCT_OFFSET_MOUNT_NEXT
    0x40, //KSTRUCK_OFFSET_MOUNT_VNODELIST
    ...
    0x70, // KSTRUCT_OFFSET_VNODE_V_TYPE
    0x78, // KSTRUCT_OFFSET_VNODE_V_UBCINFO
    0x50, // KSTRUCT_OFFSET_UBCINFO_CSBLOBS
    0xb8, // KSTRUCT_OFFSET_VNODE_V_NAME
    0xc0, // KSTRUCT_OFFSET_VNODE_V_PARENT
    ...
    0x10, // KSTRUCT_SANDBOX_SLOT
    0x10, // KSTRUCT_SPECFLAGS,
    0x31, //KSTRUCT_APFS_DATA_FLAG
    0x8, // KSTRUCT_AMFI_SLOT
...
uint32_t kernel_offsets_12_0[] = {
    ...
    0x240, // KSTRUCT_OFFSET_PPOC_NAME
    0x230, // KSTRUCT_OFFSET_P_TEXTVP
    0xA4, // KSTRUCT_OFFSET_CSB_BLOB_PLATFORM_BINARY
...
uint32_t kernel_offsets_14_0[] = {
    ...
    0x30, // KSTRUCT_OFFSET_TASK_PREV
    0xd8,  // KSTRUCT_OFFSET_TASK_ITK_SELF
    0x330, // KSTRUCT_OFFSET_TASK_ITK_SPACE
#if __arm64e__
    0x3A0, // KSTRUCT_OFFSET_TASK_BSD_INFO
#else
    0x390, // KSTRUCT_OFFSET_TASK_BSD_INFO
#endif
#if __arm64e__
    0x3a8, // KSTRUCT_OFFSET_TASK_ALL_IMAGE_INFO_ADDR
#else
...
#endif
#if __arm64e__
    0x3F4, // KSTRUCT_OFFSET_TASK_TFLAGS
#else
    0x3D8, // KSTRUCT_OFFSET_TASK_TFLAGS
#endif
    0x0, // KSTRUCT_OFFSET_TASK_LOCK
    ...
    0xf8, // KSTRUCT_OFFSET_PROC_P_FD
    0x10, // KSTRUCT_OFFSET_PROC_TASK
    0xf0, // KSTRUCT_OFFSET_PROC_UCRED
    0x0, // KSTRUCT_OFFSET_PROC_P_LIST
    0x280, // KSTRUCT_OFFSET_PROC_P_CSFLAGS
    0x3f8, // KSTRUCT_OFFSET_PROC_P_MEMSTAT_STATE
    0x50, // KSTRUCT_OFFSET_PROC_MLOCK
    0xe8, // KSTRUCT_OFFSET_PROC_UCRED_MLOCK
    0x20, // KSTRUCT_OFFSET_PROC_SVUID
    0x24, // KSTRUCT_OFFSET_PROC_SVGID
    0x240, // KSTRUCT_OFFSET_PPOC_NAME
    0x220, // KSTRUCT_OFFSET_P_TEXTVP
    
    0xA0, // KSTRUCT_OFFSET_CSB_BLOB_PLATFORM_BINARY
